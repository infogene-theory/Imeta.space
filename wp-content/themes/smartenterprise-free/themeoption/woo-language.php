...
function woo_language_option_function(){
	...
	$woo_language_l9  = trim($_POST['woo_language_l9']);
	$woo_language_l0  = trim($_POST['woo_language_l0']);
	}
	if($_POST['Submit2']) {
	...
	$woo_language_p8  = trim($_POST['woo_language_p8']);
	$woo_language_p9  = trim($_POST['woo_language_p9']);
	$woo_language_p10  = trim($_POST['woo_language_p10']);
	$woo_language_p11  = trim($_POST['woo_language_p11']);
	}if($_POST['Submit5']) {
	...
	if($_POST['Submit0']) {
		...
		$woo_language_cart11  = trim($_POST['woo_language_cart11']);
	...
	$update_main_queries[] = update_option('woo_language_l9', $woo_language_l9);
	$update_main_queries[] = update_option('woo_language_l0', $woo_language_l0);
	}if($_POST['Submit2']) {
	...
	$update_main_queries[] = update_option('woo_language_p8', $woo_language_p8);
	$update_main_queries[] = update_option('woo_language_p9', $woo_language_p9);
	$update_main_queries[] = update_option('woo_language_p10', $woo_language_p10);
	$update_main_queries[] = update_option('woo_language_p11', $woo_language_p11);
		}if($_POST['Submit5']) {
	...
	$update_main_queries[] = update_option('woo_language_cart11', $woo_language_cart11);
...
$woo_language_l9 = get_option('woo_language_l9');
$woo_language_l0 = get_option('woo_language_l0');
...
$woo_language_p8 = get_option('woo_language_p8');
$woo_language_p9 = get_option('woo_language_p9');
$woo_language_p10 = get_option('woo_language_p10');
$woo_language_p11 = get_option('woo_language_p11');
...
$woo_language_cart11= get_option('woo_language_cart11');
      ...
      <tr>
       <th scope="row"><label for="woo_language_l1">用户登录</label>
          ...
          <tr>  
           ...
           <th scope="row"><label for="woo_language_l3">用户名/电邮/电话</label>
                </th>
                <td>
          ...
          <tr> 
           ...
           <th scope="row"><label for="woo_language_l8">立即登录</label>
             ...
             <tr> 
           <th scope="row"><label for="woo_language_l9">这个手机号码已经被注册了</label>
                </th>
                <td>
               <input  type="text" size="60"  name="woo_language_l9" id="woo_language_l9" value="<?php echo $woo_language_l9; ?>"/>  <br />

                 <p>新加入电话登陆功能，注册和修改电话号码时提示</p>
                </td>
            </tr>
              <tr> 
           <th scope="row"><label for="woo_language_l0">请填写手机号码</label>
                </th>
                <td>
               <input  type="text" size="60"  name="woo_language_l0" id="woo_language_l0" value="<?php echo $woo_language_l0; ?>"/>  <br />
      ...
      <tr id="person">
           ...
           <th scope="row"><label for="woo_language_p4">我的下载</label>
             ...
             <tr> 
               ...
               <tr> 
                     <th scope="row"><label for="woo_language_p8">会员中心</label>
                     </th>
                     <td>
                     <input  type="text" size="60"  name="woo_language_p8" id="woo_language_p8" value="<?php echo $woo_language_p8; ?>"/>  <br />

                     <p>如果你使用了woocommerce-memberships会员等级插件，可以在此替换会员中心的文字</p>
                     </td>
            </tr>
            
            
              <tr> 
                     <th scope="row"><label for="woo_language_p9">我的优惠券</label>
                     </th>
                     <td>
                     <input  type="text" size="60"  name="woo_language_p9" id="woo_language_p9" value="<?php echo $woo_language_p9; ?>"/>  <br />

                     <p>如果你使用了智能优惠券插件，那么这个文字会显示在个人中心</p>
                     </td>
            </tr>
            
               <tr> 
                     <th scope="row"><label for="woo_language_p10">我的团购</label>
                     </th>
                     <td>
                     <input  type="text" size="60"  name="woo_language_p10" id="woo_language_p10" value="<?php echo $woo_language_p10; ?>"/>  <br />

                     <p>如果你使用了团购，那么这个文字会显示在个人中心</p>
                     </td>
            </tr>
            
              <tr> 
                     <th scope="row"><label for="woo_language_p11">我的余额</label>
                     </th>
                     <td>
                     <input  type="text" size="60"  name="woo_language_p11" id="woo_language_p11" value="<?php echo $woo_language_p11; ?>"/>  <br />

                     <p>如果你使用了团购，这个是团购失败退款余额的按钮</p>
                     </td>
            </tr>
     ...
     <table> <tr>
      ...
      <tr id="cart">
           ...
           <th scope="row"><label for="woo_language_cart0">移除商品</label>
            ...
            <tr> 
           <th scope="row"><label for="woo_language_cart11">如果您有优惠券代码，请在下面应用代码。</label>
                </th>
                <td>
               <input  type="text" size="60"  name="woo_language_cart11" id="woo_language_cart11" value="<?php echo $woo_language_cart11; ?>"/>  <br />
     ...
     <table> <tr>
      ...
      <tr id="chackout">
           ...
           <th scope="row"><label for="woo_language_carts6">收货人姓名：</label>
             ...
             <tr> 
           <th scope="row"><label for="woo_language_carts7">电话号码：</label>
                </th>
                <td>
           ...
           <th scope="row"><label for="woo_language_carts9">邮编：</label>
              ...
              <tr> 
           <th scope="row"><label for="woo_language_carts0">修改收货资料</label>
                </th>
                <td>
